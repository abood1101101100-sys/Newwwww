...
DEFAULT_WELCOME = "مرحباً {first}، كيف حالك؟ 👋"
DEFAULT_GOODBYE = "إلى اللقاء {first}! 👋"

DEFAULT_WELCOME_MESSAGES = [
    "مرحباً {first}! أهلاً وسهلاً 🎉",
    "أهلاً {first}! يسعدنا وجودك معنا 😊",
    "مرحباً بك {first}! 🌟",
    "انضم {first} إلى المجموعة! رحبوا به 👏",
    "{first} وصل! أهلاً وسهلاً 🎊",
    "أهلاً {first}، كنا بانتظارك! 💫",
    "مرحباً {first}! نتمنى لك وقتاً ممتعاً 🌺",
    "{first} انضم إلى العائلة! 🏠",
    "يا هلا بـ{first}! 🎈",
    "{first} هنا! رحبوا بالعضو الجديد 🌸",
    "أهلاً {first}! المجموعة أصبحت أجمل بوجودك 😄",
    "مرحباً {first}! نورت المجموعة ✨",
    "{first} انضم! الكل يرحب به 🤝",
    "يا مرحبا! {first} وصل 🎶",
    "أهلاً بـ{first} في مجموعتنا! 🌼",
    "{first} معنا الآن! أهلاً وسهلاً 💙",
    "مرحباً {first}! من أين أتيت؟ 😄",
    "الجديد {first} انضم! رحبوا به 🌟",
    "يا هلا وغلا بـ{first}! 🌹",
    "{first} أهلاً في مجموعتنا! 🎯",
]
