...
Mukesh = [
    [
        InlineKeyboardButton(text="المالك 👑", user_id=OWNER_ID),
        InlineKeyboardButton(text="الدعم", url=f"https://t.me/{SUPPORT_CHAT}"),
    ],
    [
...
async def restart(client, m: Message):
    ...
    await m.reply_photo(
        START_IMG,
        caption=f"""**مرحباً، أنا 『[{BOT_NAME}](f"t.me/{BOT_USERNAME}")』**
   ━━━━━━━━━━━━━━━━━━━
